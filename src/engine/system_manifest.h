    ...
    QVector<Capability> caps = {
        ...
        { QStringLiteral("kicad_schematic"),
          ...
          QStringLiteral("You can generate real KiCad schematics directly — not by clicking "
                         ...
                         "battery|motor_dc|l298n|connector3|transistor_npn|crystal|button|esp32\","
                         ...
                         "'transistor_npn' is Q_NPN_BEC: pin 1=Base, 2=Emitter, 3=Collector "
                         "(KiCad also has a Q_NPN_CBE with the same drawing and a different pin "
                         "order — this one is BEC, don't assume). 'crystal' is a plain 2-pin "
                         "crystal, not the 3-pin resonator. 'button' is SW_Push (pins 1/2). "
                         "'esp32' is the ESP32-WROOM-32 module: 39 pins, 2=3V3, 3=EN, and pins "
                         "1/15/38/39 are all GND (the library really does place them at the same "
                         "point — wire any one of them). "
